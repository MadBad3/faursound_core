...
class etiltEOL(_wavEOL):
    ...
    def __init__(self, wav_file, n_fft:int , hop_length:int ,fn:str,) -> None:
        ...
        super().__init__(wav_file=wav_file, n_fft=n_fft, hop_length=hop_length)
    ...
    def stft_custom_spec_to_pic(self, output_folder: str, vmin: int = VMIN, vmax: int = VMAX,
                                figsize=_wavEOL.FIGSIZE, dpi = _wavEOL.DPI, suffix:str = ''):
        ...
        :param vmax: [vmax]
        :type vmax: int
        :param figsize: [figsize], defaults to _wavEOL.FIGSIZE
    ...
    def save_stft_cv_pic(self, output_folder: str, figsize=_wavEOL.FIGSIZE,suffix:str = '') -> None:
    ...
    def cv_prepocess(self, image_path):
        if self.direction == 'Down':
            ...
            raise KeyError('etiltEOL have direction not up and down -> can not do cv_preprocess')
        return color_img
