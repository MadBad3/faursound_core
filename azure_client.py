...
class fsAzureStorage(object):
    ...
    def _upload_file(self,container_name, file_path):
    ...
    def upload_to_azure(self,cv_pic_path, txt_path, predict_pic_path):
        self._update_date()
        self._upload_file(container_name = self.cv_pic_container, file_path=cv_pic_path)
        self._upload_file(container_name = self.txt_container, file_path=txt_path)
        self._upload_file(container_name = self.predict_pic_container, file_path=predict_pic_path)
